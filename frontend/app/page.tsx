          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex-1 flex justify-end">
              <Button onClick={handleLogout}
                variant="default"
                className="bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white font-semibold shadow-md transition-all text-sm h-9"
              >
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
                {workflowSteps.slice(1).map((step) => (
                  <Link key={step.id} href={step.route || "#"}>
                    <Button
                      variant="outline"
                      className={`w-full h-auto p-4 flex flex-col items-center space-y-2 hover:shadow-lg transition-shadow duration-200 bg-gradient-to-br ${step.color} hover:text-white group`}
                    >
