                                ...
                                <div className="relative">
                                    ...
                                    >
                                        <div className="flex items-center">
                                            ...
                                            <span className="text-sm truncate">{companyFilter === "all" ? "All Companies" : companyFilter}</span>
                                        </div>
                                        <ChevronDown className="h-4 w-4 text-gray-500" />
                                    </button>
                                    {showCompanyDropdown && (
                            ...
                            {filteredJobs.length === 0 ? (
                                ...
                                filteredJobs.map((job) => (
                                    <div
                                        ...
                                        className={`bg-white rounded-lg shadow-lg p-4 hover:shadow-xl transition-all duration-300 cursor-pointer ${selectedJob?.name === job.name ? 'ring-2 ring-blue-500' : ''
                                            }`}
                                    >
                                        <div className="flex items-start justify-between">
                                            <div className="flex-1">
                                                ...
                                                <p className="text-xs text-gray-500 mb-3">ID: {job.name}</p>

                                                <div className="grid grid-cols-2 gap-2 text-sm mb-3">
                                                    <div className="flex items-center gap-2">
                                                        <Users className="h-4 w-4 text-blue-600 flex-shrink-0" />
                                                        <span className="text-gray-700 truncate">{job.designation || "Not Set"}</span>
                                                    </div>
                                                    <div className="flex items-center gap-2">
                                                        <Building className="h-4 w-4 text-green-600 flex-shrink-0" />
                                                        <span className="text-gray-700 truncate">{job.company || "Not Set"}</span>
                                                    </div>
                                                </div>
                        ...
                        {selectedJob ? (
                            ...
                            <div className="bg-white rounded-lg shadow-lg sticky top-8">
                                <div className="p-12 text-center">
                                    ...
                                    <h3 className="text-lg font-semibold text-gray-700 mb-2">Select a Job Opening</h3>
                                    <p className="text-sm text-gray-600">Click on any job opening to view its details</p>
                                </div>
                            </div>
                        )}
                    </div>
