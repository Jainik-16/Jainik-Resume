...
#             "meeting_link": data.get("meeting_link"),  # Added
#             "location": location,
#             "status": status,
...
#         if data.get("meeting_link"):  # Added
#              interview_doc.meeting_link = data.meeting_link   
#         if data.get("status"):
...
#     try:
#         # Get all users with specific roles or all employees
#         interviewers = frappe.get_all(
#             "User",
#             filters={
#                 "enabled": 1,
